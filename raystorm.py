...
parser = argparse.ArgumentParser(
    description="raystorm, low bandwidth stress test tool for websites"
)
...
def main():
    ...
    while True:
        try:
            ...
            logging.info("Stopping raystorm")
            break
        except Exception as e:
            logging.debug("Error in raystorm iteration: %s", e)
